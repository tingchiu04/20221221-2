...
function drawFlower(clr,clr_r,clr_r_r,size=1){
  ...
  scale(size) //縮放
    noStroke()
    fill(clr)
    ellipse(0+mouseX/150,0+mouseY/150,350,320) //頭

    ellipse(-130+mouseX/30,-140+mouseY/30,145) //左耳
    ellipse(130+mouseX/30,-140+mouseY/30,145) //右耳
  ...
  endShape(CLOSE)
    ...
    fill("#ffeedd")
    ellipse(0+mouseX/150,30+mouseY/150,305,250) //臉中淺色部分
    
    fill(255)//左眼框
    ellipse(-60+mouseX/150,15+mouseY/150,70)  
    fill("#f08080") 
    arc(-60+mouseX/150, 20+mouseY/150, 80, 80, 160, 320)      
    fill(255)
    arc(-58+mouseX/150, 20+mouseY/150, 70, 75, 160, 320) 

    fill(255)//右眼框
    ellipse(60+mouseX/150,15+mouseY/150,70) 
    fill("#f08080")
    arc(60+mouseX/150, 20+mouseY/150, 80, 80, 220, 20)     
    fill(255)
    arc(58+mouseX/150, 20+mouseY/150, 70, 75, 220, 20)  

    fill(clr_r) //左眼珠
    ellipse(-55+map(mouseX,0,width,-12,5)+mouseX/150,15+map(mouseY,0,height,-7,10)+mouseY/150,50)
    fill(clr_r_r)
    ellipse(-55+map(mouseX,0,width,-12,5)+mouseX/150,15+map(mouseY,0,height,-7,10)+mouseY/150,30)
    fill(255)
    ellipse(-50+map(mouseX,0,width,-5,12)+mouseX/150,10+map(mouseY,0,height,-7,10)+mouseY/150,15)

    fill(clr_r) //右眼珠
    ellipse(55+map(mouseX,0,width,-5,12)+mouseX/150,15+map(mouseY,0,height,-7,10)+mouseY/150,50)
    fill(clr_r_r)
    ellipse(55+map(mouseX,0,width,-5,12)+mouseX/150,15+map(mouseY,0,height,-7,10)+mouseY/150,30)
    fill(255)
    ellipse(65+map(mouseX,0,width,-5,12)+mouseX/150,10+map(mouseY,0,height,-7,10)+mouseY/150,15)

    fill("#f08080") //鼻子
    ellipse(0+mouseX/150,30+mouseY/150,15,10)
  ...
  endShape(CLOSE)
  beginShape()  //右手
      curveVertex(105+mouseX/150,125+mouseY/150)
      curveVertex(210+mouseX/150,190+mouseY/150)
      curveVertex(200+mouseX/150,230+mouseY/150)
      curveVertex(145+mouseX/150,215+mouseY/150)
      curveVertex(90+mouseX/150,180+mouseY/150)
  ...
  {
    fill("#5fa8d3") //嘴
    ellipse(0+mouseX/150,90+mouseY/150,35,30)
  }
  else
  {
    fill("#5fa8d3") //嘴
    ellipse(0+mouseX/150,90+mouseY/150,30,10)
